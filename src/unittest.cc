...
UT::Probe::Probe( const std::string & cmdString,   // cmd-string
...
void UT::Probe::isTrue( const bool expr, const string & exprStr )
{
   if(expr)
   {
      step_passed(*this);
...
void UT::Probe::isOK( const std::string & actual )
{
   step_passed(*this);
}

void UT::Probe::except( const exception & e)
{
   ostringstream oss;
...
void UT::Probe::expect( const string & e )
{
